...
var Colors = {};
var Ranking = ["PL", "GR", "RU", "CZ", "NL", "DK", "DE", "PT", "ES", "IT", "IE", "HR", "UA", "SE", "GB", "FR"];
...
function init() {
    ...
    (function () {
        ...
        $("all-top-quotes").addEvent("click", function (b) {
            b.stop();
            a.busy || (c.removeClass("selected"), this.addClass("selected"), filteredTeams = Ranking, a.filter(filteredTeams, {
                onComplete: function () {
                    a.setupLabels()
                }
            }))
        ...
        function (b) {
            a.busy || (b.stop(), c.removeClass("selected"), this.addClass("selected"), filteredTeams = Ranking.filter(function (a) {
                ...
                a = new $jit.StreamChart({
                    ...
                    Tips: {
                        ...
                        onShow: function (a, b, c) {
                            ...
                            a.innerHTML = "<b>" + d + "</b> tweets for <b>" + "hi" + "</b> on " + [c[1], c[2], c[0]].join("/")
                        }
                    },
                    Events: {
                        enable: !0,
